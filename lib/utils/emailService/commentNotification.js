const verificationMailTemplate = (url, commenter, recipient, title, comment) => {
  const message = `<!DOCTYPE html>
    ...
    <body style="background-color: #e9ecef;">
      ...
      <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
        Hey, There is a new comment on your article.
      </div>
      <!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 2px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <p style="margin: 0; padding: 20px; padding-bottom: 0px; border-top-style: none;">A comment was made by ${commenter} on your article : <strong>${title}<strong></p>
                </td>
              </tr>
              <tr>
