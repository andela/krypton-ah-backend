const verificationMailTemplate = (url, commenter, recipient, title, comment, mainComment) => {
  const message = `<!DOCTYPE html>
      ...
      <body style="background-color: #e9ecef;">
        ...
        <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
          A Comment was made on your response.
        </div>
        <!-- end preheader -->
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                  <td align="left" bgcolor="#ffffff" style="padding: 2px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <p style="margin: 0; padding: 20px;">A comment was made by ${commenter} on your response to article : <strong>${title}<strong></p>
                  </td>
                </tr>
                <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 14px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <p align="center" bgcolor="#1a82e2"><strong>Comment<strong></p>
                  <p style="padding: 14px; line-height: 24px; border-style:solid; border-width: 1px"><strong>${mainComment}<strong></p>
                  <p style="padding: 14px; line-height: 24px; border-style:solid; border-width: 1px"><strong>${comment}<strong></p>
                </td>
              </tr>
                <!-- end copy -->
